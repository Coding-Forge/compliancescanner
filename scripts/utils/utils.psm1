<#
.SYNOPSIS
Verify that a folder exists if it does not then 
create the folder

.DESCRIPTION
Useful for checking a folder path and creating one if does not exist

.EXAMPLE
CheckOuputDirectory -OutputPath "C:\Projects"
#>
